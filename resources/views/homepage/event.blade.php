...
<div class="event-holder row mt-3">        
    @foreach($content as $c)
        <div class="col-lg-4 col-md-6 col-sm-12 pb-3">
            <button class="card shadow event-box" onclick="location.href='/event/detail/{{$c->slug_name}}';">
                ...
                <div class="card-body p-2 w-100">
                    <div class="row px-2">
                        ...
                        <div class="col-lg-9 p-0 py-1">
                            <h6 class="event-title">{{$c->content_title}}</h6>
                            <h6 class="event-subtitle">[username]</h6>
                        </div>
                    </div>
                    <div style="height:45px;">
                        <p class="event-desc my-1">{{$c->content_desc}}</p>
                    </div>
