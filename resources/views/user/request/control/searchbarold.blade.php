<div style="" class="">
    ...
    <div class="d-inline-block position-relative w-75">
        ...
        <input type="text" class="form-control rounded-pill" style="padding-left: 35px;" id="fullname_search_old" placeholder="{{ __('messages.search_fname') }}" onchange="document.getElementById('data_wrapper_old_req').innerHTML = ''; infinteLoadMore_old_req(1)"
