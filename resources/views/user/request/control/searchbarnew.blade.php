<div style="" class="">
    ...
    <div class="d-inline-block position-relative w-75">
        ...
        <input type="text" class="form-control rounded-pill" style="padding-left: 35px;" id="fullname_search_new" placeholder="Search by fullname" onchange="document.getElementById('data_wrapper_new_req').innerHTML = ''; infinteLoadMore_new_req(1)" 
