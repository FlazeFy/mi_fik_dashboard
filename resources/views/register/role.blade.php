...
<script type="text/javascript">
    ...
    function loadTagByCat(cat) {        
        ...
        .done(function (response) {
            ...
            if (total == 0) {
                ...
                $('.auto-load-'+cat).html("<h5 class='text-primary'>{{ __('messages.all_viewed') }}</h5>");
                return;
            } else {
    ...
    function addSelectedTag(slug_name, tag_name, is_deleted, cat, tag_desc){
        ...
        if (slct_role.length > 0) {
            const found = slct_role.some(val => val.slug_name === slug_name);
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            $('#role-area-picker').html(`
                                ...
                                <h6 class="text-primary text-center" style="font-size:26px;">You have successfully requested the role</h6>
                            `);
