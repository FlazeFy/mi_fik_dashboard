...
<div>
    ...
    <span id="reset-uname-holder" class="d-none">
        <button class="btn btn-noline p-0 mb-2" style="color:#D5534C !important;" onclick="resetUnameEmail()"><i class="fa-solid fa-rotate-right"></i> Reset username and email</button>
    </span>
