...
<div class="position-relative">
    ...
    <form class="p-2 mt-2" action="/event/tag/add" method="POST">
        ...
        <div class="row mb-2">
            <div class="col">
                <div class="form-floating mb-2">
                    <input type="text" class="form-control nameInput" id="first_name" name="first_name" oninput="validateForm(validation)" maxlength="35" value="{{$us->first_name}}" required>
            ...
            <div class="col">
                <div class="form-floating mb-2">
                    <input type="text" class="form-control nameInput" id="last_name" name="last_name" oninput="validateForm(validation)" maxlength="35" value="{{$us->last_name}}">
        ...
        <div class="form-floating mb-3">
            <input type="username" class="form-control nameInput" id="username" name="username" value="{{$us->username}}" disabled required>
            <label for="username">Username</label>
            <a id="username_msg" class="text-danger my-2" style="font-size:13px;"></a>
        </div>
        <div class="form-floating mb-3">
            <input type="email" class="form-control nameInput" id="email" name="email" value="{{$us->email}}" disabled required>
            <label for="email">Email</label>
            <a id="email_msg" class="text-danger my-2" style="font-size:13px;"></a>
        </div>
        <div class="input-group form-floating mb-2 rounded">
            <input type="password" class="form-control nameInput" id="password" name="password" oninput="validateForm(validation)" value="{{$us->password}}" maxlength="50" required>
