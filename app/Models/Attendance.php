...
class Attendance extends Model
{
    ...
    public static function getAllAttendanceHeaders(){
        $res = Attendance::select('attendance.id as id', 'contents_headers.content_title', 'attendance_title', 'attendance_time_start', 'attendance_relations.attendance_answer')
