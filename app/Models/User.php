...
class User extends Authenticatable
{
    ...
    protected $fillable = ['id', 'firebase_fcm_token', 'username', 'email', 'password', 'first_name', 'last_name', 'role', 'image_url', 'batch_year', 'created_at', 'updated_at', 'updated_by', 'deleted_at', 'deleted_by', 'accepted_at', 'accepted_by', 'is_accepted'];
